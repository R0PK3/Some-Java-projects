...
public class Drink extends Good{
    ...
    public Drink(String name, int quantity, BigDecimal cost, BigDecimal expirationDate, int temperature){

        super(name,quantity,cost,expirationDate); //super() constructor
